      ...
      imgList.map((item) => {
        ...
        if (width > height) {
          if (width > clientWidth) {
            ...
            item.size.height = Math.floor((height * clientWidth) / width)
          } else {
          ...
          if (height > clientHeight) {
            ...
            item.size.width = Math.floor((width * clientHeight) / height)
          } else {
            ...
            {imgList &&
              imgList.map((item, index) => (
                <div
                  ...
                  className={index === current ? 'cw-image show' : 'cw-image'}
                >
                  <img src={item.imgUrl} />
                  <div className="cw-title">
                    {index === current ? (
                      <Tooltip placement="top" title={imgList[current].value}>
